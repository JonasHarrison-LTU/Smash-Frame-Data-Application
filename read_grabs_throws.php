        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <label>Grab</label>
                        <p class="p form-control-static"><?php echo $row["grab"]; ?></p>
                    </div>
					<div class="form-group">
                        <label>Forward Throw</label>
                        <p class="p form-control-static"><?php echo $row["forward_throw"]; ?></p>
                    </div>
					<div class="form-group">
                        <label>Back Throw</label>
                        <p class="p form-control-static"><?php echo $row["back_throw"]; ?></p>
                    </div>
					<div class="form-group">
                        <label>Up Throw</label>
                        <p class="p form-control-static"><?php echo $row["up_throw"]; ?></p>
                    </div>
					<div class="form-group">
                        <label>Down Throw</label>
                        <p class="p form-control-static"><?php echo $row["down_throw"]; ?></p>
                    </div>
