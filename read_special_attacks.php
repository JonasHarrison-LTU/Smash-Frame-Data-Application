            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <p class="p form-control-static"><?php echo $row["neutral_special"]; ?></p>
                    </div>
					<div class="form-group">
                        <label>Side Special</label>
                        <p class="p form-control-static"><?php echo $row["side_special"]; ?></p>
                    </div>
					<div class="form-group">
                        <label>Up Special</label>
                        <p class="p form-control-static"><?php echo $row["up_special"]; ?></p>
                    </div>
					<div class="form-group">
                        <label>Down Special</label>
                        <p class="p form-control-static"><?php echo $row["down_special"]; ?></p>
                    </div>
